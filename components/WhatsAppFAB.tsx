...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-5 z-50 flex items-center gap-2.5 bg-[#25d366] hover:bg-[#1ebe5c] text-white font-bold px-4 py-3 rounded-full shadow-lg transition-all hover:scale-105 group"
    >
      {/* WhatsApp icon */}
      ...
      <span className="text-sm whitespace-nowrap">Need help?</span>
    </a>
  );
}
